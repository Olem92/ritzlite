...
public class ResourcePacksManager
{
	...
	void changeOverlayColor()
	{
		if (configManager.getConfiguration(ResourcePacksConfig.GROUP_NAME, ResourcePacksConfig.ORIGINAL_OVERLAY_COLOR) == null)
		{
			configManager.setConfiguration(ResourcePacksConfig.GROUP_NAME, ResourcePacksConfig.ORIGINAL_OVERLAY_COLOR,
				configManager.getConfiguration(RuneLiteConfig.GROUP_NAME, ResourcePacksPlugin.OVERLAY_COLOR_CONFIG));
		}
		...
		configManager.setConfiguration(RuneLiteConfig.GROUP_NAME, ResourcePacksPlugin.OVERLAY_COLOR_CONFIG, overlayColor);
	...
	void resetOverlayColor()
	{
		if (configManager.getConfiguration(ResourcePacksConfig.GROUP_NAME, ResourcePacksConfig.ORIGINAL_OVERLAY_COLOR) != null)
		{
			configManager.setConfiguration(RuneLiteConfig.GROUP_NAME, ResourcePacksPlugin.OVERLAY_COLOR_CONFIG,
